...
::dmonitored::Kindly note that the device(s) has been monitored.
...
>> Followed first time login https://plazza.orange.com/docs/DOC-1681153 `r
>> User Authenticator configured `r

::resmfa:: Kindly note that your authenticator has been configured after following the First office 365 login steps https://plazza.orange.com/docs/DOC-1681153 as per our call.

::flipkb:: As per KB: REQ/2015.00152-A.11

::kbmpa:: >> Guided user to use MPA `r
>> User Unlocked account `r
>> User changed password using MPA `r

::resmpa:: Kindly note that your account has been unlocked using My password attitude https://plazza.orange.com/docs/DOC-2049526 as per our call.

^+c::
send, ^c
run, https://renicm89-sso.equant.com/itkb/itkb.nsf?opendatabase&login
sleep, 4000
Click, 320 377 
send, ^v
send, `r
...
::kbadmin:: 
>> Guided user on how to use adminute
>> https://plazza.orange.com/docs/DOC-1616171
